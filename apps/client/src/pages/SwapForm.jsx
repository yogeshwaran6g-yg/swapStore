      ...
      <div className="container mx-auto px-6 lg:px-12 pt-24 pb-20 relative z-10 animate-fade-in flex justify-center">
        <div className="w-full max-w-3xl">
          ...
          <div className="mb-10 text-center">
            <h1 className="text-4xl lg:text-5xl font-black mb-4 tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">Swap to INR</h1>
            <p className="text-zinc-400 text-lg font-medium">Execute seamless crypto-to-fiat withdrawals instantly to your bank account.</p>
          </div>

          <div className="backdrop-blur-xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-500/20 rounded-[2rem] p-8 md:p-12 shadow-2xl relative">
            {loadingProfile ? (
