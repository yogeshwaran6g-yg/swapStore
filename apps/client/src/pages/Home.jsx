...
function Home() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-[#FFDFD6] to-[#FFEBE5] text-[#0F172A] font-sans overflow-x-hidden selection:bg-[#FF4500]/30 pt-28 pb-20 px-4 sm:px-8">
              ...
              {[
                ...
                <a 
                  ...
                  className={`text-[11px] lg:text-[11px] xl:text-[14px] px-2 lg:px-2 xl:px-4 py-1 lg:py-1 xl:py-2 rounded-full transition-all whitespace-nowrap ${
                    activeTab === tab.id 
                      ? 'font-bold text-[#E65100] bg-white shadow-sm' 
                      : 'font-semibold text-[#64748B] hover:text-[#E65100] hover:bg-white/80'
                  }`}
                >
                  {tab.label}
                </a>
          ...
          <div className="lg:w-1/2 relative z-10 flex flex-col gap-8 items-center lg:items-start text-center lg:text-left">
            ...
            <div className="mt-4">
              <button
                ...
                className="bg-gradient-to-r from-[#FF8C00] to-[#FF4500] text-white px-10 py-4 rounded-2xl font-[800] text-[17px] transition-all duration-300 hover:scale-[1.03] shadow-xl shadow-[#FF4500]/30 inline-flex items-center gap-2 border border-white/20"
              >
                Get Loan
